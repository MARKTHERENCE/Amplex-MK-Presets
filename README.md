...
#### UPDATE: As of September 4, 2024, NaLex's website has been removed again. Presuming that he is likely looking for another blogspot name (or possibly a new web domain), I will provide a [OneDrive mirror link]( https://1drv.ms/f/s!Aj2M95S7YBPBhG2hOInxBYVJ28cZ?e=uCO9sL ) in the meantime. This already includes every version of Amplex for compatibility reasons, and the stock presets provided by NaLex himself.
